...
namespace OculusSampleFramework
{
	public class PanelHMDFollower : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			//transform.position = (ControllerR.transform.position + ControllerL.transform.position)/2;
			//transform.position.z = ControllerR.transform.position.z;
		}
		...
		private void Update()
		{
			...
			//transform.position = new Vector3(ControllerR.transform.position.x, ControllerR.transform.position.y, ControllerR.transform.position.z);
		}
